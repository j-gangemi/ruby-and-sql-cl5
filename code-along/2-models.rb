...
# 4. query companies table to find single row for Apple
    ...
    # below does the same as above but without having to insert the specific array row
    # BUT if there are multiple rows with name = Apple, 
    # it will only return the first row that it finds
